...
class ProvidesRandomDendriticLocations(sciunit.Capability):
    ...
    def get_random_locations_multiproc(self, dendritic_type, num, seed, dist_range):
        ...
        self.dend_locations, actual_distances = pool.apply(self.get_random_locations, (dendritic_type, num, seed, dist_range,))  # this way model.dend_loc gets the values
        pool.terminate()
        pool.join()
        del pool
