...
class ModelLoader_AMPA_NMDA_from_mod_Poirazi(ModelLoader):

    def __init__(self, name="model", mod_files_path=None):
        """ Constructor. """
        """ This class should be used with Jupyter notebooks"""
        super(ModelLoader_AMPA_NMDA_from_mod_Poirazi, self).__init__(name=name, mod_files_path=mod_files_path)
